    ...
    <div>
      ...
      <Card>
        <Row label="Computer Name">
          <span style={{ fontSize: "12px", color: dark ? "rgba(255,255,255,0.5)" : "rgba(0,0,0,0.5)" }}>Nishant's MacBook Pro</span>
        </Row>
      </Card>
    </div>
  );
...
const SoundPanel = () => {
  ...
  const alertSounds = [
    ...
    { label: "Nishant Intro", value: "music/akashintro.wav" },
  ];
        ...
        <div style={{ flex: 1, paddingBottom: isMobile ? "20px" : "0" }}>
          {isMobile && !search.trim() && (
            ...
            >
              ...
              <div>
                <div style={{ fontSize: "20px", fontWeight: 400, color: dark ? "#fff" : "#000", letterSpacing: "-0.5px" }}>Nishant Kumar</div>
